...
export function Header() {
  ...
  return (
    <header className="h-16 border-b border-border bg-card/60 backdrop-blur-xl px-6 flex items-center justify-between sticky top-0 z-20">
      {/* Left: Quick Context */}
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2.5 px-3 py-1.5 rounded-xl border border-border bg-muted/40 hover:bg-muted text-sm font-semibold transition-colors shadow-sm"
          >
        ...
        {/* Demo Mode Badge */}
        <div className="hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 text-xs font-medium">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2.5 p-1 rounded-xl hover:bg-muted/70 transition-colors"
          >
            <img
